...
export const metadata: Metadata = {
  ...
  description:
    'Roy Bejjani Audit Firm provides expert accounting, tax, audit, and business advisory services in Lebanon. Licensed certifiec accountant in Lebanon. Get professional financial solutions for your business.',
  keywords: [
  ...
  openGraph: {
    title: 'Professional Accounting & Audit Services | Roy Bejjani Audit Firm',
    description:
      'Expert accounting, tax, audit, and business advisory services in Lebanon. Licensed certified accountant in Lebanon.',
            ...
            <div className="flex justify-center mb-8">
              <div className="flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/20">
                ...
                <span className="text-sm font-semibold">
                  Licensed Certified Accountant in Lebanon
                </span>
              </div>
            </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Licensed CPA in Lebanon</span> with
